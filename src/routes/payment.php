...
use Sashagm\Payment\Http\Controllers\PaymentPayokController;
...
Route::post('/payment/payok_form', [PaymentPayokController::class, 'payokForm'])->name('payokForm');
...
Route::post('/payment/payok', [PaymentPayokController::class, 'payok'])->name('payok');
